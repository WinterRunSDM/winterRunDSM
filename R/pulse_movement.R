...
pulse_movement <- function(proportion_pulse,
                           .intercept = winterRunDSM::wr_sdm_baseline_params$.pulse_movement_intercept,
                           .proportion_pulse = winterRunDSM::wr_sdm_baseline_params$.pulse_movement_proportion_pulse,
                           .medium = winterRunDSM::wr_sdm_baseline_params$.pulse_movement_medium,
                           .large = winterRunDSM::wr_sdm_baseline_params$.pulse_movement_large,
                           .vlarge = winterRunDSM::wr_sdm_baseline_params$.pulse_movement_vlarge,
                           .medium_pulse = winterRunDSM::wr_sdm_baseline_params$.pulse_movement_medium_pulse,
                           .large_pulse = winterRunDSM::wr_sdm_baseline_params$.pulse_movement_large_pulse,
                           .very_large_pulse = winterRunDSM::wr_sdm_baseline_params$.pulse_movement_very_large_pulse){
