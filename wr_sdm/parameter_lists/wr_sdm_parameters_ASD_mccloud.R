...
wr_sdm_params_asd_mccloud <- list(
  ...
  spawning_habitat = DSMhabitat::wr_spawn$action_5_upper_sac_mccloud_tmh,
  inchannel_habitat_fry = DSMhabitat::wr_fry$action_5_upper_sac_mccloud_tmh, # vary by run
  inchannel_habitat_juvenile = DSMhabitat::wr_juv$action_5_upper_sac_mccloud_tmh, # vary by run
  floodplain_habitat = DSMhabitat::wr_fp$action_5_upper_sac_mccloud_tmh, # vary by run
...
usethis::use_data(wr_sdm_params_asd_mccloud, overwrite = TRUE)
