...
The model spins up using several years of data (years 1-6) to seed the model before producing results for year 1. This allows the model to produce more results for the limited time series. Thus you can see differences between the baseline and portfolio starting in simulation year 1. 
