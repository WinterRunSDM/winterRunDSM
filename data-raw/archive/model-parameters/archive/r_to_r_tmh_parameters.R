...
calibration_solution <- read_rds("calibration/calibration-results-2021-10-11_125845.rds")
...
r_to_r_tmh_params <- list(
  ...
  spawning_habitat = DSMhabitat::wr_spawn$r_to_r_tmh,
  inchannel_habitat_fry = DSMhabitat::wr_fry$r_to_r_tmh, # vary by run
  inchannel_habitat_juvenile = DSMhabitat::wr_juv$r_to_r_tmh, # vary by run
  floodplain_habitat = DSMhabitat::wr_fp$r_to_r_tmh, # vary by run
